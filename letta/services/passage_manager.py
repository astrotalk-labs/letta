...
class PassageManager:
    ...
    def insert_passage(
        ...
        # Route to Azure embeddings if GrowthBook flag is on OR userId % 10 < 3
    ...
    async def insert_passage_async(
        ...
        # Route to Azure embeddings via GrowthBook flag or mod10 fallback (30% rollout)
        embedding_config = agent_state.embedding_config
        uid = gb_user_id or str(actor.id)
        use_azure = False
        experiments_service = get_experiments_service()
