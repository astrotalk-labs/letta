...
class EmbeddingConfig(BaseModel):
    ...
    embedding_endpoint: str | None = Field(None, description="The endpoint for the model (`None` if local).")
    ...
    embedding_chunk_size: int | None = Field(300, description="The chunk size of the embedding.")
    handle: str | None = Field(None, description="The handle for this config, in the format provider/model-name.")

    # azure only
    azure_endpoint: str | None = Field(None, description="The Azure endpoint for the model.")
    azure_version: str | None = Field(None, description="The Azure version for the model.")
    azure_deployment: str | None = Field(None, description="The Azure deployment for the model.")

    @classmethod
    def default_config(cls, model_name: str | None = None, provider: str | None = None):
