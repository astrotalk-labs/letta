...
class LettaImage(ImageSource):
    ...
    media_type: str | None = Field(None, description="The media type for the image.")
    data: str | None = Field(None, description="The base64 encoded image data.")
    detail: str | None = Field(
        None,
        description="What level of detail to use when processing and understanding the image (low, high, or auto to let the model decide)",
    )
...
ImageSourceUnion = Annotated[UrlImage | Base64Image | LettaImage, Field(discriminator="type")]
...
class ReasoningContent(MessageContent):
    ...
    signature: str | None = Field(None, description="A unique identifier for this reasoning step.")
