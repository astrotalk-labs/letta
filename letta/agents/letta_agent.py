...
# Haiku cascade is gated to these user IDs during initial validation.
# Once metrics confirm latency improvement, expand to all latencyOptimisationFlow traffic.
_CASCADE_GATED_USER_IDS: frozenset = frozenset({"92744418"})
